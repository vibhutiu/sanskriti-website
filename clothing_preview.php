...
?>
    ...
    <input type="hidden" value="clothingin.php" name="page" />
    
<button type="submit" class="btn btn-default" id="buynow" formaction="add_to_buynow.php">Buy Now</button>
<button type="submit" class="btn btn-default" id="addtocart" formaction="clothing_add_to_cart.php">Add to Cart</button>
    </form>

...
<script>
...

    {
        ...
        document.getElementById("total").value=t+t*0.18+delc;
...
<?php
    ...
    while($i<$size)
    {
        ...
        <input class="qnt form-control" class="form-control" type="number" style="float:left;  width:50px; position:relative; top:55px; right:15px; background:white;" value="'.$row[$i]['quantity'].'" onchange="sum1()" name="q[]" disabled="disabled"></div></div>';
...
<input type="hidden" name="type" value="cart.php" />
<button type="submit" class="btn"  name="vibhu" form="form1" style="width:200px;
background:#660033; color:#FFFFFF;" formaction="edit_common.php">Edit Items</button>
<br />
<br />
<input type="hidden" name="tab" value="cart" />
<button type="submit" class="btn" id="buy" name="vibhu" form="form1" formaction="payment.php" formtarget="_self">Continue with Payment</button>
</form>

...
<?php
    ...
    else
    {
        ...
        <input class="qnt form-control" class="form-control" type="number" style="float:left;  width:50px; position:relative; top:55px; right:15px; background:white;" value="'.$quantity.'" onchange="sum1()" name="q[]" disabled="disabled"></div></div>';
...
<input type="hidden" name="type" value="edit_buy_now.php" />
...
<br />
<br />
<input type="hidden" name="tab" value="buynow" />
